  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Check Out Details</h1>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
      ...
      <div class="container-fluid">
        ...
        @if(!$paymentCompleted)
          <div class="alert alert-warning">
            Payment must be completed before check-out.
          </div>
        @endif
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{ route('resepsionis.checkout') }}" method="POST">
              @csrf
              ...
              <div class="d-flex justify-content-between">
                <a href="{{ url('resepsionis/checkout') }}" class="btn btn-secondary">Back</a>
                <button type="submit" class="btn btn-primary" {{ !$paymentCompleted ? 'disabled' : '' }}>Check Out</button>
              </div>
            </form>
          </div>
        </div>
