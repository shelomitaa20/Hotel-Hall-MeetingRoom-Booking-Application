        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('tambah_ruangan') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tambah Data</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('lihat_ruangan') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lihat Data</p>
                </a>
              </li>
                  ...
                  <tbody>
                    @foreach ($data as $index => $ruangan)
                      <tr>
                        ...
                        <td>
                          @if ($ruangan->gambar)
                            <img src="{{ asset('storage/' . $ruangan->gambar) }}" alt="{{ $ruangan->nama_ruangan }}" width="100">
                          @else
                            Tidak ada gambar
                          @endif
                        </td>
